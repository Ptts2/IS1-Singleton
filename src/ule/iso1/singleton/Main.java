...
public class Main {
	...
	public static void main(String[] args) {
	       ...
	       VATtoApply va1 = VATtoApply.getInstance(0.16);    // cambiar por la linea anterior para utilizar el patrón Singleton
	 
	      // Intenta instanciar un segundo singleton: debe devolver la misma instancia
	      // VATtoApply va2 = VATtoApply.getInstance(0.20);
	       VATtoApply va2 = VATtoApply.getInstance(0.20);    // cambiar por la linea anterior para utilizar el patrón Singleton
	     ...
	     VATtoApply va3 = VATtoApply.getInstance(0.30);  // cambiar por la linea anterior para utilizar el patrón Singleton
